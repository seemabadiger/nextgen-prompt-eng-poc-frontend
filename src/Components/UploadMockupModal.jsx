  ...
  return (
    <Modal show={show} onHide={handleClose} size="lg">
      ...
      <Modal.Body>
        ...
        <Form.Label style={{ fontSize: '0.875rem', color: '#6E6E6E', fontWeight: 'bold' }}>Select Section</Form.Label>
        <div>
          {['Visual samples', 'Case Studies', 'Process Diagrams', 'Before After'].map((section) => (
            <Form.Check
              type="radio"
              label={section}
              name="section"
