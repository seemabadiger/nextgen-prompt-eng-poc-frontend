...
const UploadMockupModal = ({ show, handleClose, onUpload }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append("MockupType", fields.section);
      fields.tags.forEach((tag) => {
        formData.append(`Tags`, tag);
      });

      await axios.post(
        `https://hxstudiofileupload.azurewebsites.net/api/FileUploadAPI/upload?userId=${user.id}`,
        formData,
        {
          headers: {
    ...
    <Modal show={show} onHide={handleClose} size="lg">
      ...
      <Modal.Body>
          ...
          <div className="select-section-list">
            {[
              ...
              <Form.Check
                ...
                label={section}
                name="section"
                id={`section-${fields.section}`}
                value={fields.section}
                checked={fields.section === section}
        ...
        <Form.Group className="mb-3">
          ...
          <Editor ref={editorRef} onTextChange={handleChange} />
        </Form.Group>
        <Form.Group className="mb-3">
          <Form.Label
            style={{ fontSize: "1.2rem", color: "#6E6E6E", fontWeight: "bold" }}
          >
            Attach files
          </Form.Label>
          <div
